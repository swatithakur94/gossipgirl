					...
					[
							...
							function($scope, $filter, $UserService, $fileUpload) {
								...
								$scope.setFile = function(element) {
									...
									console.log('file is :');
									console.dir(file);
									var uploadUrl = "http://localhost:9080/gossipgirl/updateProfilePicture/";
...
<body style="background-color:#FFE4E1" ng-app="myApp" ng-controller="myCtrl">
			...
			<div>
				<div ng-if="time<12">
					<img alt="good morning"
						ng-src="${pageContext.request.contextPath}/resources/images/morning2.png"
						width="50" height="50"> Good Morning
				</div>

				<div ng-if="time>=12 && time<=17">
					<img alt="good morning"
						ng-src="${pageContext.request.contextPath}/resources/images/morning1.jpg"
						width="50" height="50"> Good Afternoon
				</div>

				<div ng-if="time>17 && time<24">
					<img alt="good morning"
						ng-src="${pageContext.request.contextPath}/resources/images/goodnight.png"
		...
		<div class="col-md-3 text-center">
			<div ng-if="userdetails.gender == 'Male'">
				...
				<img ng-src="{{userdetails.Image}}" width="150" height="150"
					id="profilepic"
					onerror="this.src='${pageContext.request.contextPath}/resources/images/male.jpg'">
			</div>
			<div ng-if="userdetails.gender == 'Female'">
				<img ng-src="{{userdetails.Image}}" width="150" height="150"
					id="profilepic"
					onerror="this.src='${pageContext.request.contextPath}/resources/images/userfemale.png'">
			</div>
	...
	<div class="container">
		...
		<div class="col-md-4" style="margin-top: 30px">
			...
			<a href="allusers" class="btn btn-danger btn-block btn-outline"><img
				src="${pageContext.request.contextPath}/resources/images/p.png"
		...
		<div class="col-md-4" style="margin-top: 30px">
			...
			<a href="talk" class="btn btn-danger btn-block btn-outline"><img
