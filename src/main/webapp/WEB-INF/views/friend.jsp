...
<div class="col-md-4 col-md-offset-4">
	...
	<button class="btn btn-danger " ng-click="viewFriendRequset();">Friend Requests &nbsp<span class="badge">{{countfriendrequests}}</span></button>
		...
		no request
			...
			<div class="panel-footer">
				<a href="http://localhost:9080/gossipgirl/talk/friendchat/{{user.friendId.userId}}" class="btn btn-danger btn-sm" ng-disabled="!user.online" role="button"><i class="fa fa-paper-plane-o" aria-hidden="true"></i>&nbsp SEND MESSAGE</a>
